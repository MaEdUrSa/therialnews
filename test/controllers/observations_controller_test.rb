...
class ObservationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create observation" do
    assert_difference("Observation.count") do
      post observations_url, params: { observation: { content: @observation.content, post_id: @observation.post_id, user_id: @observation.user_id } }
    end
  ...
  test "should update observation" do
    patch observation_url(@observation), params: { observation: { content: @observation.content, post_id: @observation.post_id, user_id: @observation.user_id } }
